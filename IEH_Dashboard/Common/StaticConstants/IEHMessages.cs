namespace IEH_Dashboard.Common.StaticConstants
{
    /// <summary>
    ...
    public static class IEHMessages
    {
        ...
        /// <summary>
        /// Gets or sets the RequestCoundNotProceed
        /// </summary>
        public static string RequestCoundNotProceed = "Request Cound not proceed";
